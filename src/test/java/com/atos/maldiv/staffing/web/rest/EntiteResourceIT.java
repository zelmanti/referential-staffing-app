...
public class EntiteResourceIT {
    ...
    public void createEntite() throws Exception {
        ...
        // Create the Entite
        restEntiteMockMvc
            .perform(post("/api/entites").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entite)))
    ...
    public void updateEntite() throws Exception {
        ...
        restEntiteMockMvc
            .perform(put("/api/entites").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedEntite)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingEntite() throws Exception {
        ...
        restEntiteMockMvc
            .perform(put("/api/entites").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entite)))
            .andExpect(status().isBadRequest());
