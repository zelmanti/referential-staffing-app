...
public class DFinanciereResourceIT {
    ...
    public void createDFinanciere() throws Exception {
        ...
        restDFinanciereMockMvc
            .perform(
                post("/api/d-financieres").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(dFinanciere))
            )
    ...
    public void getAllDFinancieres() throws Exception {
        ...
        restDFinanciereMockMvc
            .perform(get("/api/d-financieres?sort=id,desc"))
    ...
    public void getDFinanciere() throws Exception {
        ...
        // Get the dFinanciere
        restDFinanciereMockMvc
            .perform(get("/api/d-financieres/{id}", dFinanciere.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingDFinanciere() throws Exception {
        // Get the dFinanciere
        restDFinanciereMockMvc.perform(get("/api/d-financieres/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateNonExistingDFinanciere() throws Exception {
        ...
        restDFinanciereMockMvc
            .perform(
                put("/api/d-financieres").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(dFinanciere))
            )
            .andExpect(status().isBadRequest());
    ...
    public void deleteDFinanciere() throws Exception {
        ...
        restDFinanciereMockMvc
            .perform(delete("/api/d-financieres/{id}", dFinanciere.getId()).accept(MediaType.APPLICATION_JSON))
