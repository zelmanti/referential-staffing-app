...
public class ForfaitResourceIT {
    ...
    public void createForfait() throws Exception {
        ...
        // Create the Forfait
        restForfaitMockMvc
            .perform(post("/api/forfaits").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(forfait)))
    ...
    public void getAllForfaits() throws Exception {
        ...
        restForfaitMockMvc
            .perform(get("/api/forfaits?sort=id,desc"))
    ...
    public void getForfait() throws Exception {
        ...
        // Get the forfait
        restForfaitMockMvc
            .perform(get("/api/forfaits/{id}", forfait.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingForfait() throws Exception {
        // Get the forfait
        restForfaitMockMvc.perform(get("/api/forfaits/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateForfait() throws Exception {
        ...
        restForfaitMockMvc
            .perform(
                put("/api/forfaits").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedForfait))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingForfait() throws Exception {
        ...
        restForfaitMockMvc
            .perform(put("/api/forfaits").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(forfait)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteForfait() throws Exception {
        ...
        // Delete the forfait
        restForfaitMockMvc
            .perform(delete("/api/forfaits/{id}", forfait.getId()).accept(MediaType.APPLICATION_JSON))
