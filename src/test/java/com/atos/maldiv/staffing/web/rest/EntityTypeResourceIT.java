...
public class EntityTypeResourceIT {
    ...
    public void createEntityType() throws Exception {
        ...
        restEntityTypeMockMvc
            .perform(
                post("/api/entity-types").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entityType))
            )
    ...
    public void getAllEntityTypes() throws Exception {
        ...
        restEntityTypeMockMvc
            .perform(get("/api/entity-types?sort=id,desc"))
    ...
    public void getEntityType() throws Exception {
        ...
        // Get the entityType
        restEntityTypeMockMvc
            .perform(get("/api/entity-types/{id}", entityType.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingEntityType() throws Exception {
        // Get the entityType
        restEntityTypeMockMvc.perform(get("/api/entity-types/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateNonExistingEntityType() throws Exception {
        ...
        restEntityTypeMockMvc
            .perform(
                put("/api/entity-types").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entityType))
            )
            .andExpect(status().isBadRequest());
    ...
    public void deleteEntityType() throws Exception {
        ...
        restEntityTypeMockMvc
            .perform(delete("/api/entity-types/{id}", entityType.getId()).accept(MediaType.APPLICATION_JSON))
