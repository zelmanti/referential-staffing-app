...
public class LMissionResourceIT {
    ...
    public void createLMission() throws Exception {
        ...
        // Create the LMission
        restLMissionMockMvc
            .perform(post("/api/l-missions").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lMission)))
    ...
    public void getAllLMissions() throws Exception {
        ...
        restLMissionMockMvc
            .perform(get("/api/l-missions?sort=id,desc"))
    ...
    public void getLMission() throws Exception {
        ...
        // Get the lMission
        restLMissionMockMvc
            .perform(get("/api/l-missions/{id}", lMission.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingLMission() throws Exception {
        // Get the lMission
        restLMissionMockMvc.perform(get("/api/l-missions/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateLMission() throws Exception {
        ...
        restLMissionMockMvc
            .perform(
                put("/api/l-missions").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedLMission))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingLMission() throws Exception {
        ...
        restLMissionMockMvc
            .perform(put("/api/l-missions").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lMission)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteLMission() throws Exception {
        ...
        // Delete the lMission
        restLMissionMockMvc
            .perform(delete("/api/l-missions/{id}", lMission.getId()).accept(MediaType.APPLICATION_JSON))
